import Enfrentamientos from './Enfrentamientos'
    ...
    return (
        <div>
            <div className="tabla-torneo-contenedor">
                <h2>{torneo.nombre_torneo} - TABLA DE RESULTADOS</h2>
            ...
            <div className='tabla-enfrentamientos'>
                <Enfrentamientos />
            </div>
            <div className="btns-resultados">
                <button onClick={onClose} className="btn-cerrar-resultados">
                    Cerrar Tablas
                </button>
                <button onClick={onClose} className="btn-imprimir-resultados">
